description="""
PB-coul-tailcorrection is a trajectory post-processing app that computes a correction
...
parser = argparse.ArgumentParser(
    ...
    epilog="PB-coul-tailcorrection is built using Sire and is distributed "
